...
function docSyncLeafGates(options: {
  ...
  return [
    ...
    pnpmExec('docs-site-projection', ['vitest', 'run', 'scripts/project-doc-site.spec.ts', 'scripts/project-doc-site-english.spec.ts', 'scripts/verify-doc-site-fragments.spec.ts'], {
