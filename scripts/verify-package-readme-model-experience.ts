...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/api/browser-controller': { kind: 'none', reason: 'Forwards live browser state and controls to the Web client; the browser tool owns model-visible results.' },
  'packages/client/ui-authenticator': { kind: 'none', reason: 'Displays authenticated account responses without changing model requests.' },
  'packages/client/ui-mobile-access': { kind: 'none', reason: 'Controls the Tailscale listener without changing model requests.' },
  'packages/host/mobile-access': { kind: 'none', reason: 'Adds an authenticated network listener without changing model requests.' },
  'packages/client/ui-browser': { kind: 'none', reason: 'Presents browser screenshots and action history without changing model context.' },
  ...
  'packages/client/ui-settings-usage': { kind: 'none', reason: 'Browser-side usage dashboard; registers no model surface.' },
  ...
  'packages/api/usage-controller': { kind: 'none', reason: 'Historical usage reader; registers no prompt, tool, or session event.' },
  ...
  'packages/web/web-search-searxng': { kind: 'indirect', reason: 'The JSON search provider delegates model-visible result rendering and logging to dsh-tool-web.' },
