 ...
 * and the foot holds Settings, adjacent actions, and the footer action row; the shell
  ...
  return (
    ...
    >
      ...
      <div className={css.regionArea}>
        {renderSlot('sidebar.automations', { wide })}
      ...
      <div className={css.footArea}>
        ...
        <div className={css.settingsRow}>
          ...
          <div className={css.settingsActions}>{renderSlot('sidebar.settings.action', { wide })}</div>
        </div>
      </div>
    </div>
  )
