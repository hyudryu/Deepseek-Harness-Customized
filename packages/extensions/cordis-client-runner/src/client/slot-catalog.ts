...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'The right browser panel, shown when the layout opens it and expandable up to ~50% of the frame.',
    doc: 'The right browser panel, shown when the layout opens it and expandable\nup to ~50% of the frame. OCCUPIED by ui-browser\'s BrowserPanel, which\nrenders the live per-session browser. Absent an occupant the column\nrenders nothing.\n\nNo owner props: the framework injects the session id and hooks for the\n`session` scope, and `ctx.layout` owns whether the column is open.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-browser BrowserPanel',
    ],
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Session browser control in the upper-right corner of the application.',
    doc: 'Session browser control in the upper-right corner of the application.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-browser StartBrowserDock',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.session.banner',
    kind: 'list',
    scope: 'session',
    summary: 'Full-width session notices below the header and above the transcript.',
    doc: 'Full-width session notices below the header and above the transcript.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-super-goal SuperGoalBanner id \'super-goal\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.banner\', () => ctx.slots.register(\n      { name: \'conversation.session.banner\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins SearxngCard',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-usage UsageSection id \'usage\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.automations',
    kind: 'single',
    scope: 'root',
    summary: 'Optional plugin seat rendered directly above the workspace browsing region.',
    doc: 'Optional plugin seat rendered directly above the workspace browsing\nregion. Declared by this package\'s \'sidebar\' entry; a plugin (e.g.\ndsh-automations) registers a tab here. Rendered in wide and rail states.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.automations\', () => ctx.slots.register(\n      { name: \'sidebar.automations\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'sidebar.workspaces.actions',
    kind: 'list',
    scope: 'root',
    summary: 'Feature-plugin contributions to a workspace row\'s ellipsis menu (declared by the WorkspaceBrowser entry): merged before the built-in Rename/Delete.',
    doc: 'Feature-plugin contributions to a workspace row\'s ellipsis menu (declared\nby the WorkspaceBrowser entry): merged before the built-in Rename/Delete.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.actions\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.actions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
