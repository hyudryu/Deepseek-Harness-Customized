...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'sessionMcp',
    summary: 'Starts with the application and drains its requests before releasing its listener.',
    description: 'Starts with the application and drains its requests before releasing its listener.',
    methods: [],
  },
  {
