...
import usageControllerRemote from '@deepseek-ai/dsh-api-usage-controller/remote'
...
import browserControllerRemote from '@deepseek-ai/dsh-api-browser-controller/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, commandsRemote, settingsControllerRemote, usageControllerRemote, goalsRemote, llmRemote, dynamicRemote,
      pluginInventoryRemote, messageFeedbackRemote, fileUploadsRemote, sessionReferencesRemote,
      subagentsRemote, sessionRemote, workspaceRemote, browserControllerRemote,
    ]) {
