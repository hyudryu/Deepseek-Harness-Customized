...
When a shipped note is unlikely to guide future work, archive its English file and any existing companions through [`dsh-archive-agent-notes`](../../skills/dsh-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
