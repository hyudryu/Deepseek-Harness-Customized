...
Treat generated catalogs, snapshots, and fixtures as derivative. Trace every consumer before editing: source JSDoc may also feed a generated model-visible catalog. Edit the owning source or scenario first, then regenerate every derivative. When a generator extracts a summary from owner prose, make the extracted sentence complete for that surface. English is the maintained documentation language. Follow [the writing rules](../../../docs/AGENTS.md#writing-rules); legacy translations do not require updates or sidecar records.
