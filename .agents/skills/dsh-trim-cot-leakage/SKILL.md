...
3. Fix the owner first: update source JSDoc or generator templates before regenerating catalogs; update English type-equivalence fences from their source declarations. English prose and fences require no translation update or sidecar record under [the writing rules](../../../docs/AGENTS.md#writing-rules). Model- or user-visible strings require owning behavior evidence and follow [dsh-prose-standard](../dsh-prose-standard/SKILL.md); otherwise leave them unchanged and report the deferral.
