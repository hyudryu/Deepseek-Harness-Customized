...
- Review English documentation under [the fork language policy](../../../docs/i18n/README.md); legacy translations and sidecars are not required updates.
...
- **Explicit translation changes:** review meaning and terminology only for translations the user requested.
