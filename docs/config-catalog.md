...
- `@deepseek-ai/dsh-api-browser-controller` — requires `typert` · `browserControl` ([`packages/api/browser-controller/src/index.ts`](../packages/api/browser-controller/src/index.ts))
