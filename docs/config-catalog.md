...
Requires: `webServer` · `connection` · `settings` · `tools`
...
Source: [`packages/host/authenticator/src/index.ts:23`](../packages/host/authenticator/src/index.ts)
...
Source: [`packages/host/mobile-access/src/index.ts:16`](../packages/host/mobile-access/src/index.ts)
...
- `@deepseek-ai/dsh-api-browser-controller` — requires `typert` · `browserControl` · `sessions` ([`packages/api/browser-controller/src/index.ts`](../packages/api/browser-controller/src/index.ts))
...
- `@deepseek-ai/dsh-client-ui-super-goal` ([`packages/client/ui-super-goal/src/index.ts`](../packages/client/ui-super-goal/src/index.ts))
