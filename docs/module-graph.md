...
flowchart TD
  ...
  subgraph group_skill["packages/skill"]
    ...
    pkg_skill_catalog_buckets["skill-catalog-buckets"]
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_super_goal["client-ui-super-goal"]
  ...
  pkg_super_goal --> pkg_agent
  pkg_super_goal --> pkg_commands
  pkg_super_goal --> pkg_invariants
  pkg_super_goal --> pkg_llm
  pkg_super_goal --> pkg_session
  pkg_super_goal --> pkg_session_projection
  pkg_super_goal --> pkg_tools
  pkg_super_goal --> pkg_user_questions
  ...
  pkg_web_search_searxng --> pkg_system_prompt
  pkg_web_search_searxng --> pkg_tools
  ...
  pkg_skill_catalog_buckets --> pkg_agent
  pkg_skill_catalog_buckets --> pkg_skill
  pkg_skill_catalog_buckets --> pkg_tool_skill
  pkg_skill_catalog_buckets --> pkg_tools
  ...
  pkg_session_mcp --> pkg_agent
  pkg_session_mcp --> pkg_host_webserver
  pkg_session_mcp --> pkg_session
  pkg_session_mcp --> pkg_session_query
  pkg_session_mcp --> pkg_session_title
  pkg_session_mcp --> pkg_workspace
...
| [`client-ui-super-goal`](../packages/client/ui-super-goal) | `client` | — |
...
| [`tool-skill`](../packages/skill/tool-skill) | `skill` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`skill`](../packages/skill/skill), [`tools`](../packages/core/tools) |
| [`tool-web`](../packages/web/tool-web) | `web` | [`llm`](../packages/llm/llm), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`web`](../packages/web/web) |
| [`web-search-searxng`](../packages/web/web-search-searxng) | `web` | [`settings`](../packages/settings/settings), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`web`](../packages/web/web) |
...
| [`mcp-client`](../packages/mcp/mcp-client) | `mcp` | [`attachment`](../packages/attachment/attachment), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`subprocess`](../packages/subprocess/subprocess), [`system-prompt`](../packages/core/system-prompt), [`timeout`](../packages/util/timeout), [`tools`](../packages/core/tools) |
...
| [`skill-catalog-buckets`](../packages/skill/skill-catalog-buckets) | `skill` | [`agent`](../packages/core/agent), [`skill`](../packages/skill/skill), [`tool-skill`](../packages/skill/tool-skill), [`tools`](../packages/core/tools) |
...
| [`session-mcp`](../packages/mcp/session-mcp) | `mcp` | [`agent`](../packages/core/agent), [`host-webserver`](../packages/host/webserver), [`session`](../packages/core/session), [`session-query`](../packages/session-query/session-query), [`session-title`](../packages/session/session-title), [`workspace`](../packages/workspace/workspace) |
