...
- **English-only documentation**: write and maintain English sources. No Chinese counterpart, matching line count, language switcher, or translation record is required. Existing translations are optional legacy material; `dsh-translate-docs` remains user-invoked ([policy](i18n/README.md)).
