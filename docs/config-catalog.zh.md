...
来源： [`packages/skill/skill-catalog-buckets/src/index.ts:20`](../packages/skill/skill-catalog-buckets/src/index.ts)
...
来源：[`packages/skill/tool-skill/src/index.ts:88`](../packages/skill/tool-skill/src/index.ts)
